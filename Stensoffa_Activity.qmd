...
```{r actogram_datetime}
stf_data_actogram_raw <- data_actogram_raw %>%  
...
#| warning: false  
stf_data_actogram_raw$time <- as.character(stf_data_actogram_raw$time)

ggplot(stf_data_actogram_raw, aes(x = time, y = date, fill = !!sym(activity))) + 
  geom_tile() +   
