...
watson.two.test(deg2rad(Emlen_capture_Sub$Mean), deg2rad(Emlen_capture_Pol$Mean), alpha=0.05)
watson.two.test(deg2rad(Emlen_control_Sub$Mean), deg2rad(Emlen_control_Pol$Mean), alpha=0.05)
watson.two.test(deg2rad(Emlen_treatment_Sub$Mean), deg2rad(Emlen_treatment_Pol$Mean), alpha=0.05)
```
