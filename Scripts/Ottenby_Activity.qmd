...
gr_emmeans_mod1s_week<-as.data.frame(emmeans(gr_mod1s_week, specs = c("DayNight","experiment","Week"), 
                                        level=0.95))
```
...
raw_Exp_DayNight_MeanData <- mean_activity_DayNight[
  c("DayNight", "experiment", "DayNight_activity","Week")]
plot_data_mod1s_week <- merge(gr_emmeans_mod1s_week, raw_Exp_DayNight_MeanData, 
                         by = c("DayNight", "experiment"))
```
