...
```{r Mass_df, message = FALSE, warning = FALSE}
#| output: false
#| include: false
...
```{r plot_basic_mass, message = FALSE, warning = FALSE}
...
```{r plot_basi_cond, message = FALSE, warning = FALSE}
...
```{r BodyCond_Mass_plot, message = FALSE, warning = FALSE}
...
```{r Diff_massFat, message = FALSE, warning = FALSE}
...
```{r plot_diff_MassFat, message = FALSE, warning = FALSE}
...
```{r mass_mod1, message = FALSE, warning = FALSE}
...
```
```{r mass_alone_mod1, message = FALSE, warning = FALSE}
Mass_alone_mod1<-lmer(Mass ~ Treatment + (1|Ring) + (1|Species), data= Mass_data,
                na.action = na.exclude)

check_model(Mass_alone_mod1)

summary(Mass_alone_mod1)

mean_Mass_alone_mod1<-emmeans(Mass_alone_mod1, ~Treatment)
mean_Mass_alone_mod1

pairs(mean_Mass_alone_mod1)

gr_Mass_alone_mod1 <- ref_grid(Mass_alone_mod1, cov.keep=c("Treatment"))
gr_emmeans_Mass_alone_mod1<-as.data.frame(emmeans(gr_Mass_alone_mod1, 
                                            specs = c("Treatment"), 
                                            level=0.95))

mean_Mass_alone_mod1<- as.data.frame(mean_Mass_alone_mod1)

raw_Mass_alone_mod1 <- Mass_data[c("Treatment", "Mass")]  

plot_data_Mass_alone_mod1 <- merge(gr_emmeans_Mass_alone_mod1, raw_Mass_alone_mod1,
                        by = c("Treatment")) 

ggplot(mean_Mass_alone_mod1, aes(x = Treatment, y = emmean)) +
  geom_jitter(data = plot_data_Mass_alone_mod1, aes(x = Treatment, y = Mass),
              color="lightgray") +
  geom_point() +
  geom_linerange(aes(ymin = lower.CL, ymax = upper.CL), alpha = 0.5,
                 position = position_dodge2(width = 1), size=1)+
...
model_performance(Mass_alone_mod1)

null_mass_alone_mod1<- lmer(Mass ~ 1 + (1|Ring) + (1|Species), data= Mass_data,
                na.action = na.exclude)
anova(Mass_alone_mod1, null_mass_alone_mod1, test="LTR")
...
```{r fat_mod1, message = FALSE, warning = FALSE}
...
```{r mass_mod2, message = FALSE, warning = FALSE}
...
```{r mass_alone_mod2, message = FALSE, warning = FALSE}
Mass_alone_mod2<-lmer(Mass ~ Treatment*BreedingDistribution + 
                  (1|Ring) + (1|Species), data= Mass_data,
                na.action = na.exclude)

check_model(Mass_alone_mod2)

summary(Mass_alone_mod2)

mean_Mass_alone_mod2<-emmeans(Mass_alone_mod2, ~Treatment*BreedingDistribution)
mean_Mass_alone_mod2

pairs(mean_Mass_alone_mod2)

gr_Mass_alone_mod2 <- ref_grid(Mass_alone_mod2, cov.keep=
                           c("Treatment", "BreedingDistribution"))
gr_emmeans_Mass_alone_mod2<-as.data.frame(emmeans(gr_Mass_alone_mod2, 
                                            specs = c("Treatment",
                                                      "BreedingDistribution"), 
                                            level=0.95))

mean_Mass_alone_mod2<- as.data.frame(mean_Mass_alone_mod2)

raw_Mass_alone_mod2 <- Mass_data[c("Treatment", "Mass","BreedingDistribution")]  

plot_data_Mass_alone_mod2 <- merge(gr_emmeans_Mass_alone_mod2, raw_Mass_alone_mod2,
                        by = c("Treatment","BreedingDistribution")) 

ggplot(mean_Mass_alone_mod2, aes(x = Treatment, y = emmean)) +
  geom_jitter(data = plot_data_Mass_alone_mod2, aes(x = Treatment, y = Mass),
              color="lightgray") +
  geom_point() +
  geom_linerange(aes(ymin = lower.CL, ymax = upper.CL), alpha = 0.5,
                 position = position_dodge2(width = 1), size=1)+
...
model_performance(Mass_alone_mod2)

null_mass_alone_mod1<- lmer(Mass ~ 1 + (1|Ring) + (1|Species), data= Mass_data,
                na.action = na.exclude)
anova(Mass_alone_mod1, Mass_alone_mod2, null_mass_alone_mod1, test="LTR")
```
...
```{r Mass_mod1_R, message = FALSE, warning = FALSE}
...
```{r Mass_alone_mod1_R, message = FALSE, warning = FALSE}
Mass_alone_mod1_R<-lmer(Mass ~ Treatment + (1|Ring), data= Mass_data_Robin,
                na.action = na.exclude)

check_model(Mass_alone_mod1_R)

summary(Mass_alone_mod1_R)

mean_Mass_alone_mod1_R<-emmeans(Mass_alone_mod1_R, ~Treatment)
mean_Mass_alone_mod1_R

pairs(mean_Mass_alone_mod1_R)

gr_Mass_alone_mod1_R <- ref_grid(Mass_alone_mod1_R, cov.keep=c("Treatment"))
gr_emmeans_Mass_alone_mod1_R<-as.data.frame(emmeans(gr_Mass_alone_mod1_R, 
                                            specs = c("Treatment"), 
                                            level=0.95))

mean_Mass_alone_mod1_R<- as.data.frame(mean_Mass_alone_mod1_R)

raw_Mass_alone_mod1_R <- Mass_data_Robin[c("Treatment", "Mass")]  

plot_data_Mass_alone_mod1_R <- merge(gr_emmeans_Mass_alone_mod1_R, raw_Mass_alone_mod1_R,
                        by = c("Treatment")) 

ggplot(mean_Mass_alone_mod1_R, aes(x = Treatment, y = emmean)) +
  geom_jitter(data = plot_data_Mass_alone_mod1_R, aes(x = Treatment, y = Mass),
              color="lightgray") +
  geom_point() +
  geom_linerange(aes(ymin = lower.CL, ymax = upper.CL), alpha = 0.5,
                 position = position_dodge2(width = 1), size=1)+
...
model_performance(Mass_alone_mod1_R)

null_mass_alone_mod1_R<- lmer(Mass ~ 1 + (1|Ring), 
                        data= Mass_data_Robin,
                na.action = na.exclude)
anova(Mass_alone_mod1_R, null_mass_alone_mod1_R, test="LTR")
```
...
```{r mass_mod1_W, message = FALSE, warning = FALSE}
...
```{r mass_alone_mod1_W, message = FALSE, warning = FALSE}
Mass_alone_mod1_W<-lmer(Mass ~ Treatment + (1|Ring), data= Mass_data_Willys,
                na.action = na.exclude)

check_model(Mass_alone_mod1_W)

summary(Mass_alone_mod1_W)

mean_Mass_alone_mod1_W<-emmeans(Mass_alone_mod1_W, ~Treatment)
mean_Mass_alone_mod1_W

pairs(mean_Mass_alone_mod1_W)

gr_Mass_alone_mod1_W <- ref_grid(Mass_alone_mod1_W, cov.keep=c("Treatment"))
gr_emmeans_Mass_alone_mod1_W<-as.data.frame(emmeans(gr_Mass_alone_mod1_W, 
                                            specs = c("Treatment"), 
                                            level=0.95))

mean_Mass_alone_mod1_W<- as.data.frame(mean_Mass_alone_mod1_W)

raw_Mass_alone_mod1_W <- Mass_data_Willys[c("Treatment", "Mass")]  

plot_data_Mass_alone_mod1_W <- merge(gr_emmeans_Mass_alone_mod1_W, raw_Mass_alone_mod1_W,
                        by = c("Treatment")) 

ggplot(mean_Mass_alone_mod1_W, aes(x = Treatment, y = emmean)) +
  geom_jitter(data = plot_data_Mass_alone_mod1_W, aes(x = Treatment, y = Mass),
              color="lightgray") +
  geom_point() +
  geom_linerange(aes(ymin = lower.CL, ymax = upper.CL), alpha = 0.5,
                 position = position_dodge2(width = 1), size=1)+
...
model_performance(Mass_alone_mod1_W)

null_mass_alone_mod1_W<- lmer(Mass ~ 1 + (1|Ring), 
                        data= Mass_data_Willys,
                na.action = na.exclude)
anova(Mass_alone_mod1_W, null_mass_alone_mod1_W, test="LTR")
```