...
```{r mass_mod1}
Mass_mod1_stf<-lmer(BodyCond ~ Treatment + (1|Ring), data= stf_Mass_data,
...
```{r}
Mass_mod2_stf<-lmer(BodyCond ~ Treatment*ExperimentalDay + (1|Ring), data= stf_Mass_data,
                na.action = na.exclude)
...
anova(Mass_mod2_stf, Mass_mod1_stf, null_mass_mod2_stf, test="LTR")
```
